...
CGImageRef createSaturationBrightnessSquareContentImageWithHue2(float hue);
...
CGImageRef createSlideImage(int r, int g, int b, ColorRGB whichColor,bool leftOrRight,int w, int h);
